...
- 职责： 全程参与了产品的前期设计并提出相应的建议，独立负责前端的开发任务，主要完成了看新车（展会期间新车发布会及展车）、看模特（展会模特的评选）、店内看（经销商店内展车）、找优惠（经销商促销、大礼包、代金券及优惠活动）、车友（车主交流及品牌商发起的活动）等所有模块的开发工作
- 微信版： ![](https://github.com/286810/resume/blob/master/kcwc.png)
- 注：由于服务器不稳定，可能会有 bug 或访问失败
...
- [点我点](https://github.com/286810/ionic_seed_kl)

###jQuery-source-code
- jQuery源码分析
- [看这里](https://github.com/286810/jQuery-sound-code)
